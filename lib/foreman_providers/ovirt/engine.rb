  ...
  module Ovirt
    class Engine < ::Rails::Engine
      ...
      initializer 'foreman_providers_ovirt.load_app_instance_data' do |app|
        ForemanProviders::Ovirt::Engine.paths['db/migrate'].existent.each do |path|
      ...
      config.to_prepare do
        begin
          Host::Managed.send(:include, ForemanProviders::Ovirt::HostExtensions)
          HostsHelper.send(:include, ForemanProviders::Ovirt::HostsHelperExtensions)
        rescue => e
      ...
      rake_tasks do
        Rake::Task['db:seed'].enhance do
          ForemanProviders::Ovirt::Engine.load_seed
        end
      end
